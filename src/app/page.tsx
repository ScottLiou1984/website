    ...
    <>
      ...
      <main className="pt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-secondary">
                ...
                <div className="pt-8 px-8">
                  <h3 className="text-2xl font-bold text-secondary mb-2">Creativity</h3>
              ...
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-secondary">
                ...
                {/* Title */}
                <div className="pt-8 px-8">
                  <h3 className="text-2xl font-bold text-secondary mb-2">Sustainable Value</h3>
                  <div className="w-8 h-0.5 bg-secondary mb-6"></div>
                </div>
              ...
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-secondary">
                ...
                {/* Title */}
                <div className="pt-8 px-8">
                  <h3 className="text-2xl font-bold text-secondary mb-2">Flavour First</h3>
                  <div className="w-8 h-0.5 bg-secondary mb-6"></div>
                </div>
        ...
        >
          ...
          <div className="container-max relative z-10">
            <div className="text-center mb-16">
              <h2 className="section-title text-white">JOIN US TODAY</h2>
              <div className="w-20 h-1 bg-gradient-to-r from-secondary to-accent mx-auto mt-6"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-secondary">
                ...
                <div className="pt-8 px-8">
                  <h3 className="text-2xl font-bold text-secondary mb-2">BOOKING</h3>
                  <div className="w-8 h-0.5 bg-secondary mb-6"></div>
                </div>
              ...
              <div className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-secondary">
                ...
                <div className="pt-8 px-8">
                  <h3 className="text-2xl font-bold text-secondary mb-2">CONTACT US</h3>
                  <div className="w-8 h-0.5 bg-secondary mb-6"></div>
                </div>
